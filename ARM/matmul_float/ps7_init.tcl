...
#Loads the FPGA device bitstream.
...
#con
#disconnect 352
#Connects to <target_type>.
connect arm hw

ps7_init
ps7_post_config
#Downloads the given ELF or data file (with the -data option) onto the memory of the current
#target. If no address is provided along with the ELF file, the download address is determined
#from the ELF file by reading its headers.
dow matmul_float.elf

#Continues from current PC
con
#Disconnects from the current processor target, closes the corresponding GDB server, and
